psql postgresql://postgres:postgres@localhost:5432/postgres -c \
    "DROP DATABASE IF EXISTS hello_worlds;"

psql postgresql://postgres:postgres@localhost:5432/postgres -c \
    "CREATE DATABASE hello_worlds;"

psql postgresql://postgres:postgres@localhost:5432/hello_worlds -c \
...
#randomly generate 1000000 rows
